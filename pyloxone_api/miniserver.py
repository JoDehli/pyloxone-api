...
class Miniserver(ConnectorMixin, TokensMixin):
    def __init__(
        ...
        self._message_listeners: list[
            tuple[asyncio.Future, list[MessageType], str]
        ] = []
    ...
    def _run_in_background(self, task: Coroutine[Any, Any, Any]) -> asyncio.Task:
        ...
        def handle_errors(task: asyncio.Task) -> None:
            try:
    ...
    async def _get_message(
        self, message_types: list[MessageType], expected_control: str = ""
    ) -> BaseMessage:
